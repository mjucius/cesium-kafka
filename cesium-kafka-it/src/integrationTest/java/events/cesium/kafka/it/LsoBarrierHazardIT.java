 ...
 * the tombstone" the task sanctions — and then starts the real {@link events.cesium.kafka.core.dispatch.DispatchLoop}
 * as the <em>new owner</em> taking over the partition, exercising the real recovery path end to end
 * (first-run cursor resolution, the real {@link events.cesium.kafka.core.dispatch.KafkaDispatchAdmin}
