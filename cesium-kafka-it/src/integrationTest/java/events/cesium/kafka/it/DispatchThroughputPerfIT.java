 ...
 *       events.cesium.kafka.core.dispatch.DispatchLoop} that re-fetches each source payload through
 *       the {@link events.cesium.kafka.core.fetch.KafkaSeekFetcher}; the rate is read off
