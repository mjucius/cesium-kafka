...
- **docs/configuration.md** — full key reference incl. locked keys with rationale, env-mapping grammar. **[docs/performance.md](performance.md)** — measured numbers (M8), the honest replay-cost formula, sizing & tuning.
