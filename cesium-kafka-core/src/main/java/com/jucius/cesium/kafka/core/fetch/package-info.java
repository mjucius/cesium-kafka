 ...
 * partition penalty-box inputs. {@link com.jucius.cesium.kafka.core.fetch.SeekFetcher} is the loop's
 * boundary; {@link com.jucius.cesium.kafka.core.fetch.KafkaSeekFetcher} is the production
 * implementation owning the group-less seek consumer, and
 * {@link com.jucius.cesium.kafka.core.fetch.FetchCandidates} normalizes a drained batch into the
