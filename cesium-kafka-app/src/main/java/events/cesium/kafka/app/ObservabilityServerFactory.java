 ...
 * ({@code events.cesium.kafka.app.metrics}) owns the server itself; this {@link java.util.ServiceLoader}
 ...
 * {@code META-INF/services/events.cesium.kafka.app.ObservabilityServerFactory}; the app loads the
