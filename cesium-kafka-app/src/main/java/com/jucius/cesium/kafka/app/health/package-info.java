/**
 * The health model (design §9): the {@link com.jucius.cesium.kafka.app.health.EngineHealth} seam the
 * engine writes and the observability layer reads, a thread-safe atomic-backed implementation
 * ({@link com.jucius.cesium.kafka.app.health.MutableEngineHealth}), and the
 * {@link com.jucius.cesium.kafka.app.health.HealthAssessor} that derives liveness and readiness.
 *
